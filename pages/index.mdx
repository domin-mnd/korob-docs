...
<Callout type="info">
  Korob doesn't come up with project creation command, only initialization. This
  is intended by design. You can use any boilerplate template you like to create
  your project.
</Callout>
